...
<acme:form>
	...
	<acme:input-moment code="authenticated.contract.form.label.instantiationMoment" path="instantiationMoment" readonly="true"/>
			</jstl:when>
	</jstl:choose>
	<jstl:choose>
	<jstl:when test="${_command == 'show' && draftMode == false}">
			<acme:button code="authenticated.progress-log.list.title" action="/authenticated/progress-log/list-all?masterId=${id}"/>			
		</jstl:when>
	</jstl:choose>
